...
void UNP4Input::UpdateDetection(float DeltaTime)
{
	UpdateGameKeys(DeltaTime);
	ProcessKeyStates(DeltaTime);
}

void UNP4Input::ProcessKeyStates(float DeltaTime)
{
...
void UNP4Input::UpdateGameKeys(float DeltaTime)
{
	ANP4TownPlayerController* MyController = CastChecked<ANP4TownPlayerController>(GetOuter());
...
void UNP4Input::DetectOnePointActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition, FVector2D& AnchorPosition, float& DownTime)
{
...
void UNP4Input::DetectTwoPointsActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition1, const FVector2D& CurrentPosition2)
{
...
FVector2D UNP4Input::GetTouchAnchor(int32 i) const
{
